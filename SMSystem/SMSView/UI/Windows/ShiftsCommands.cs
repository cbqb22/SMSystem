...
{
    public static class ShiftsCommands
    {
        /// <summary>
        /// ディレクトリ選択ダイアログ表示
        /// </summary>
        ...
        public class CloseCommand : ICommand
        {
            ...
            public void Execute(object parameter)
            {
                ...
                if (parameter is Shifts == false)
                {
                    return;
                }

                var win = parameter as Shifts;

                if (MessageBox.Show("シフト作成画面を終了しますか？", "保存", MessageBoxButton.OKCancel, MessageBoxImage.Question, MessageBoxResult.OK) == MessageBoxResult.OK)
                {
                    win.Close();
